...
export const TIERS: Record<TierId, TierDefinition> = {
  ...
  pro: {
    ...
    algorithms: ["random", "hot", "cold", "gap", "pattern", "mixed"],
    weeklyGenerationCap: 50,
    features: [
      "50 combinations weekly across multiple algorithms",
      "Gap analysis, pattern-balanced & mixed-ensemble generators",
  ...
  elite: {
    ...
    features: [
      ...
      "Markov chain, Monte Carlo & anti-syndication algorithms",
